def swap array , counter_one , counter_two 
  array[counter_one] , array[counter_two] = array[counter_two] , array[counter_one]
  return array
end

def lies_between lower , upper , number
...
def get_elements sides
  ...
  sides.each do |side|
    ...
    if bracket_status == -1
      ...
      puts "open_bracket : #{open_bracket}"
      puts "close_bracket : #{close_bracket}"
